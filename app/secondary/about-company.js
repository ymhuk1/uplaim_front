                ...
                <ImageBackground
                    ...
                    <View style={styles.containerView}>
                        ...
                        <View style={styles.addressContainer}>
                            ...
                            <TouchableOpacity style={styles.iconTextContainer} onPress={toggleTooltip} activeOpacity={1}>
                                <Image
                                    contentFit="contain"
                                    contentPosition={"center"}
                                    transition={1000}
                                    ...
                                    width={24}
                                    height={24}/>
                                <Text style={styles.textWhite}>{company.schedule !== undefined ? company.schedule : 'Не указано'}</Text>
                        ...
                        <View style={styles.contactContainer}>
                            ...
                            <TouchableOpacity style={styles.itemContactContainer} onPress={toggleTooltip}>
                                <Image
                                    contentFit="contain"
                                    contentPosition={"center"}
                                    transition={1000}
                        ...
                        <View style={styles.descriptionContainer}>
                            <Text style={styles.descriptionText}>{company.full_description}</Text>
                        </View>
                    </View>
                </ImageBackground>
            </ScrollView>
            {isTooltipVisible && (
                <Modal isVisible={isTooltipVisible} onBackdropPress={toggleTooltip} style={styles.modal}>
                    <PopupComponent onClose={toggleTooltip} height={220} headerPopup={"Режим работы:"} textPopup1={company.working_hours !== undefined ? company.working_hours : 'Не указано'} textPopup2={company.working_hours_weekend !== undefined ? company.working_hours_weekend : 'Не указано'}/>
                </Modal>
            )}
        </View>
