            ...
            <ImageBackground
                ...
                <View style={styles.containerView}>
                    ...
                    <View tyle={styles.sliderContainer}>
                        <SliderPhotoComponent photos={another_photo ? another_photo : []} style={styles.slider} />
                    </View>
                    <View style={styles.buttonContainer}>
                        {clientData.companies && clientData.companies.some(c => c.id === company.id) ? (
                            <NewButtonComponent title={'Рекомендовать'} filled={true} height={48} fontSize={18} onPress={() => {}}/>
                        ) : (
                            <NewButtonComponent title={buttonText} filled={true} height={48} fontSize={18} onPress={associateCompany}/>
                        )}
                    </View>
                    ...
                    <View style={styles.tariffContainer}>
                        ...
                        >
                            {Array.isArray(company.tariffs) && company.tariffs.map((tariff, index) => {
                                const isClientTariff = clientData.tariff && clientData.tariff.name === tariff.clients_tariff_name;
                                    ...
                                    <View style={styles.tariffContainerInner} key={tariff.id}>
                                        ...
                                        >
                                            <View style={styles.tariffBallsContainer}>
                                                <Text style={styles.tariffBallsTextDop}>из  {getBallValue(company.id, 'hide_ball') }</Text>
                                                <View style={styles.tariffBallsMain}>
                                                    <Image
                                                        ...
                                                        width={16}
                                                        height={16}/>
                                                    <Text style={styles.tariffBallsText}>{getBallValue(company.id, 'ball') + ' ' + getBallsText()}</Text>
                                                </View>
                                            </View>
                                        </LinearGradient>
                                        <View style={styles.tariffColumn}>
                                            ...
                                            >
                                                <Text style={styles.tariffColumnTextUp}>{company.max_pay_point[tariff.clients_tariff_name]}%</Text>
                                            ...
                                            <LinearGradient
                                                ...
                                                style={styles.tariffColumnItem}
                                            >
                                                <Text style={styles.tariffColumnTextUp}>{company.cashback[tariff.clients_tariff_name]}%</Text>
                                        ...
                                        {isClientTariff ? (
                                            <View style={styles.tariffPaginationRow}>
                                                ...
                                                {Array.isArray(company.tariffs) && company.tariffs.map((tariff, index) => (
                                                    <View key={index} style={index === 0 ? '' : styles.tariffPagination}></View>
                                                ))}
                                            </View>
                                            ) : (
                                            <TouchableOpacity
                                            ...
                                            >
                                                <Text style={styles.tariffConnectText}>{tariff.clients_tariff_name === 'Free' ? '' : 'Подключить ' + tariff.clients_tariff_name }</Text>
                                            </TouchableOpacity>
                                        )}
                                    </View>
                                );
                    ...
                    <TouchableOpacity  onPress={() => router.push({ pathname: "/secondary/newsCompany", params: { id: companyId } })}
                    ...
                    <SliderComponent companySlider={true} data={groupedData1} itemsPerSlide={itemsPerSlide1} itemHeight={itemHeight1} slideHeight={slideHeight1}/>
                    ...
                    <View style={styles.bannerSave}>
                        ...
                        <View style={styles.bannerSaveInfo}>
                            ...
                            <Text style={styles.bannerSaveText}>вы сэкономили с SAVEUP в этой компании</Text>
                        </View>
                    </View>
