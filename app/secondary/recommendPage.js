        ...
        <View style={styles.containerView}>
          ...
          <View style={styles.logoContainer}>
            ...
            <NewButtonComponent
              ...
              fontSize={18}
              onPress={() =>
                router.push({ pathname: "/secondary/findCompany" })
              }
            />
          </View>
            ...
            <View style={styles.leftThirdContainer}>
              <View style={styles.infoLeftThirdContainer}>
                ...
                <Text style={styles.textTwo}>
                  Ссылка на персональные&nbsp;скидки
                </Text>
              </View>
              <View style={styles.linkLeftThirdContainer}>
                <Text style={styles.textLinkLeftThirdContainer}>
                  www.website.com/pes..
                </Text>
              </View>
              <View style={styles.copyLinkLeftThirdContainer}>
                <Text style={styles.copyLinkLeftThirdText}>
                  Скопировать ссылку
                </Text>
              </View>
            </View>
