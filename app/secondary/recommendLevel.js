...
import {
    ...
    elemGradientColors, textDisabledColor,
    textPrimaryColor
    ...
    const fetchData = async () => {
        try {
            ...
            if (companyResponse.ok) {
                ...
                console.error('Ошибка при загрузке данных компании:', companyResponse.status);
            }
            ...
            if (clientResponse.ok) {
                ...
                console.error('Ошибка при загрузке данных клиента:', clientResponse.status);
            }
        } catch (error) {
                    ...
                    <View style={styles.containerView}>
                        ...
                        <View style={styles.tariffContainer}>
                            <View style={styles.wrapper}>
                                {Array.isArray(company.tariffs) && company.tariffs.map((tariff, index) => {
                                    const isClientTariff = clientData.tariff && clientData.tariff.name === tariff.name;
                                    if (isClientTariff) {
                                        return (
                                            <View style={styles.tariffContainerInner} key={index}>
                                                <TouchableOpacity
                                                    style={{zIndex: 10}}
                                                    onPress={() => router.push('/secondary/recommendLevel')}>
                                                    <View style={[styles.tariffActual, {backgroundColor: tariff.color}]}>
                                                        <Text style={[styles.tariffActualText,]}>{tariff.name}</Text>
                                                    </View>
                                                </TouchableOpacity>
                                                <LinearGradient
                                                ...
                                                >
                                                    <View style={styles.tariffBallsContainer}>
                                                        <Text
                                                            style={styles.tariffBallsTextDop}>из {getBallValue(company.id, 'hide_ball')}</Text>
                                                        <View style={styles.tariffBallsMain}>
                                                            <Image
                                                                ...
                                                                height={16}/>
                                                            <Text
                                                                style={styles.tariffBallsText}>{getBallValue(company.id, 'ball') + ' ' + getBallsText()}</Text>
                                                        </View>
                                                    </View>
                                                </LinearGradient>
                                                <View style={styles.tariffColumn}>
                                                    ...
                                                    >
                                                        <Text style={styles.tariffColumnTextUp}>{tariff.write_of_balls}%</Text>
                                                        <Text style={styles.tariffColumnTextDown}>Списание баллами</Text>
                                                    </LinearGradient>
                                                    <LinearGradient
                                                        colors={elemGradientColors}
                                                        style={styles.tariffColumnItem}
                                                    >
                                                        <Text style={styles.tariffColumnTextUp}>{tariff.cashback}%</Text>
                                                        <Text style={styles.tariffColumnTextDown}>Кешбэк</Text>
                                                    </LinearGradient>
                                                </View>
                                                {isClientTariff ? (
                                                    ...
                                                    >
                                                        <Text
                                                            style={styles.tariffConnectText}>Подключить {tariff.clients_tariff_name}</Text>
                                                    </TouchableOpacity>
                                                )}
                                            </View>
                                        );
                                ...
                                if (isClientTariff) {
                                    return (
                                        <View style={styles.tariffContainerPrivilege}>
                                            <View style={styles.wrapper}>
                                                <View style={styles.tariffContainerInnerPrivilege} key={index}>
                                                    <View style={styles.tariffColumnPrivilege}>
                                                        <View style={styles.tariffDescPrivilege}>
                                                            <View style={[styles.tariffPrivilege, {backgroundColor: tariff.color}]}>
                                                                <Text style={[styles.tariffPrivilegeText,]}>{tariff.name}</Text>
                                                            </View>
                                                            <Text style={[styles.tariffPrivilegeDopText,]}>Как получить?</Text>
                                                        </View>
                                                        ...
                                                        <LinearGradient
                                                            ...
                                                            <Text
                                                                style={styles.tariffColumnTextUp}>{tariff.write_of_balls}%</Text>
                                                            <Text style={styles.tariffColumnTextDown}>Списание
                                                                баллами</Text>
                                                        </LinearGradient>
                                                        <LinearGradient
                                                            colors={elemGradientColors}
                                                            style={styles.tariffColumnItemPrivilege}>
                                                            <Text
                                                                style={styles.tariffColumnTextUp}>{tariff.cashback}%</Text>
                                                            <Text
                                                                style={styles.tariffColumnTextDown}>Кешбэк</Text>
                                                        </LinearGradient>
                                                    </View>
                                                </View>
                                            </View>
                            ...
                            <LinearGradient
                                ...
                                <View style={styles.taskRowContent}>
                                    ...
                                    <View style={styles.taskRowMain}>
                                        <Text style={styles.taskRowMainText}>Пригласить еще 4 из 5 друзей</Text>
                            ...
                            <LinearGradient
                                ...
                                <View style={styles.taskRowContent}>
                                    ...
                                    <View style={styles.taskRowMain}>
                                        ...
                                        <Text style={styles.taskRowMainText}>Совершите операций
                                            на сумму 2575 ₽
                                            из 5000 ₽</Text>
                                        <View style={styles.taskMainStatus}>
                                            <Image
                            ...
                            <LinearGradient
                                ...
                                <View style={styles.taskRowContent}>
                                    ...
                                    <View style={styles.taskRowMain}>
                                        ...
                                        <Text style={styles.taskRowMainText}>Совершите операций вместе с
                                            друзьями на сумму 2575 ₽
                                            из 50000 ₽</Text>
                                        <View style={styles.taskMainStatus}>
                                            <Image
                                                contentFit="contain"
                        ...
                        <View style={styles.button}>
                            <NewButtonComponent title={'Рекомендовать'} filled={true} height={48} fontSize={18}/>
                        </View>
                    </View>
                </ImageBackground>
            </ScrollView>
