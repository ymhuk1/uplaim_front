        ...
        <ScrollView
            ...
            <ImageBackground
                ...
                <View style={styles.containerView}>
                    ...
                    <SliderComponent qrcode={true} data={groupedData1} itemsPerSlide={itemsPerSlide1} itemHeight={itemHeight1} slideHeight={slideHeight1}/>
                    <View style={styles.textContainer2}>
                        <Image
                            contentFit="contain"
                            contentPosition="center"
                    ...
                    <SliderComponent qrcode={true} hide={true} data={groupedData1} itemsPerSlide={itemsPerSlide1} itemHeight={itemHeight1} slideHeight={slideHeight1}/>
                </View>
            </ImageBackground>
        </ScrollView>
    );
